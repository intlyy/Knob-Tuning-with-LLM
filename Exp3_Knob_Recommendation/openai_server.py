...
def process_data():
    ...
    last_knobs = data.get('knob')
    throughput = data.get('throughput')
    now_inner_metrics = data.get('metric')
    ...
    },
    {
        ...
        """.format(knob=OLAP_knobs, inner_metric=inner_metrics, last_knob = last_knobs, now_inner_metric = now_inner_metrics, throughput = throughput, environment=OLAP_environment, db_metric = db_metric, history_knob = OLAP_history_knobs, history_metric = history_metrics, history_output = OLAP_history_output )
    }
    ]
